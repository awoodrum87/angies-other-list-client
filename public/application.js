...
/***/ (function(module, exports, __webpack_require__) {
	...
	var reviewEvents = __webpack_require__(17);
	// on document ready
	$(function () {
	  $('.create-review').hide();
	  $('.reviewActions').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var visible = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createReviewHide = function createReviewHide() {
	...
	var crReviewerHide = function crReviewerHide() {
	  if (store.user.reviewer === null) {
	...
	module.exports = {
	  ...
	  loginView: loginView,
	  crReviewerHide: crReviewerHide,
	  createReviewHide: createReviewHide,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateReviewer = function onCreateReviewer(event) {
	  console.log('create reviewer 1');
	  event.preventDefault();
	  console.log('data is ', data);
	  console.log('create reviewer 2');
	  var data = getFormFields(this);
	  api.createReviewer(data).then(ui.createProfileSuccess).catch(ui.createProfileFailure);
	};

	var onUpdateReviewer = function onUpdateReviewer(event) {
	  event.preventDefault();
	  console.log('update reviewer click is heard');

	  var data = getFormFields(event.target);
	  api.updateReviewer(data).then(ui.updateProfileSuccess).catch(ui.updateProfileFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createReviewer = function createReviewer(data) {
	  return $.ajax({
	...
	var updateReviewer = function updateReviewer(data) {
	  console.log('data is : ', data);
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onDeleteReview = function onDeleteReview(event) {
	  ...
	  api.deleteReview(id).then(ui.deleteReviewSuccess).catch(ui.deleteReviewFailure).done(onGetMyReviews);
	};
	...
	var onUpdateReview = function onUpdateReview(event) {
	  ...
	  var data = getFormFields(this);
	  var id = $(this).attr('data-id');
	  api.updateReview(id, data).then(ui.updateReviewSuccess).catch(ui.updateReviewFailure).done(onGetMyReviews);
	};
	...
	var onGetMyReviews = function onGetMyReviews(event) {
	  ...
	  // event.preventDefault()
	  api.getMyReviews().then(ui.getMyReviewsSuccess).catch(ui.getReviewsFailure);
	};

	var onInitiateLogin = function onInitiateLogin(event) {
	  event.preventDefault();
	  console.log('intiate-login click is heard');
	};

	var onGetStarted = function onGetStarted(event) {
	  event.preventDefault();
	  console.log('get started button clicks');
	};

	var onLegalDisclosure = function onLegalDisclosure(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateReview = function updateReview(id, data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showAllReviews = __webpack_require__(20);
	var showMyReviews = __webpack_require__(40);
	...
	var createReviewFailure = function createReviewFailure(error) {
	  console.error(error);
	...
	var deleteReviewFailure = function deleteReviewFailure(error) {
	  console.error(error);
	...
	var updateReviewFailure = function updateReviewFailure(error) {
	  console.error(error);
	...
	var getReviewsSuccess = function getReviewsSuccess(data) {
	  ...
	  var showReviewsHTML = showAllReviews({ reviews: data.reviews });
	  $('.content').html(showReviewsHTML);
	};

	var getMyReviewsSuccess = function getMyReviewsSuccess(data) {
	  console.log('get my reviews ui');
	  var showMyReviewsHTML = showMyReviews({ reviews: data.reviews });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <ul data-id=\""
	    ...
	    + "\">\n     <li> Date: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.review_date : stack1), depth0))
	    + "</li>\n     <li> Review: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.review_text : stack1), depth0))
	    + "</li>\n     <img src=\"https://media.giphy.com/media/3oriO7RNRqh47AempG/giphy.gif\" alt=\"Angry Reaction\" id='hillary' style=\"width:300px;height:200px;\">\n   </ul>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div id='review-actions'>\n<ul>\n\n  <li class=\"my-review-li\">Review ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</li>\n  <li class=\"my-review-li\">Date: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.review_date : stack1), depth0))
	    + " </li>\n  <li class=\"my-review-li\">Review: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.review_text : stack1), depth0))
	    + "</li>\n  <button type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#update"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Review</button>\n  <!-- <button type=\"button\" class=\"del-btn btn btn-danger\" data-toggle=\"modal\" data-target=\"#delete"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete Review</button> -->\n  <!-- <button type=\"button\" class=\"del-btn btn btn-danger\" id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.quote : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.quote : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"> Delete Quote </button> -->\n  <button type=\"button\" class=\"del-btn btn btn-danger\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\">Update This Review</h5>\n          </div>\n          <div class=\"modal-body\">\n            <form id=\"update-review\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <fieldset>\n              <input type='text' name='review[review_text]' id ='updateDescription' placeholder=\"Updated Review Text\">\n              <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update This Review\">\n          </fieldset>\n          </form>\n          </div>\n          <div class=\"modal-footer\">\n            <div class=\"updateerror\"></div>\n            <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <!-- update review modal -->\n    <!-- <div class=\"delModal modal fade\" id=\"delete"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Are you sure???</h5>\n              </div>\n              <div class=\"modal-body\">\n                <form id='delete-review-form'class=\"update-review\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                <fieldset>\n                  <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" id=\"delete-rev-submit\" value=\"Delete This Review\">\n              </fieldset>\n              </form>\n              </div>\n              <div class=\"modal-footer\">\n                <div class=\"updateerror\"></div>\n                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n              </div>\n            </div>\n          </div>\n        </div> -->\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
